...
/**
 * struct print_method - structure containing specifier and their functions.
 * @specifier: handles data using appropriate function
 * @fn: prints the function for specific type.
 */
